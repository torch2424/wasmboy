...
export function oamSearchForVisibleSprites(): void {
  // Record how many sprites we have found
  let visibleSpritesFound: i32 = 0;
  ...
  for (let i = 39; i >= 0 && visibleSpritesFound < 10; --i) {
    ...
    if (
      ...
      eightBitStoreIntoGBMemory(OAM_VISIBLE_SPRITES_LOCATION + 1 + visibleSpritesFound, i);
  ...
  // Lastly, store the number of visible sprites found
  eightBitStoreIntoGBMemory(OAM_VISIBLE_SPRITES_LOCATION, visibleSpritesFound);
}
