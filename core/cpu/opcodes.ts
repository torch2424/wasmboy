...
function handleOpcode0x(opcode: i32): i32 {
  switch (opcode) {
    ...
    case 0x02:
      ...
      eightBitStoreIntoGBMemoryWithTraps(
        concatenateBytes(Cpu.registerB, Cpu.registerC),
        Cpu.registerA
      );
      return 8;
    case 0x03:
      // INC BC
      // 1  8
      let registerBC3: u16 = <u16>concatenateBytes(
        Cpu.registerB,
        Cpu.registerC
      );
      registerBC3++;
    ...
    case 0x09:
      ...
      let registerBC9: u16 = <u16>concatenateBytes(
        Cpu.registerB,
        Cpu.registerC
      );
      checkAndSetSixteenBitFlagsAddOverflow(
    ...
    case 0x0a:
      // LD A,(BC)
      // 1 8
      Cpu.registerA = <u8>eightBitLoadFromGBMemoryWithTraps(
        concatenateBytes(Cpu.registerB, Cpu.registerC)
      );
      return 8;
    case 0x0b:
      // DEC BC
      // 1  8
      let registerBCB: u16 = <u16>concatenateBytes(
        Cpu.registerB,
        Cpu.registerC
      );
      registerBCB -= 1;
...
function handleOpcode1x(opcode: i32): i32 {
  switch (opcode) {
    case 0x10:
      ...
      if (Cpu.GBCEnabled) {
        let speedSwitch: i32 = eightBitLoadFromGBMemoryWithTraps(
          Cpu.memoryLocationSpeedSwitch
        );
    ...
    case 0x12:
      ...
      // 1 8
      eightBitStoreIntoGBMemoryWithTraps(
        concatenateBytes(Cpu.registerD, Cpu.registerE),
        Cpu.registerA
      );
      return 8;
    case 0x13:
    ...
    case 0x19:
      ...
      // - 0 H C
      let registerHL: u16 = <u16>concatenateBytes(Cpu.registerH, Cpu.registerL);
      let registerDE9: u16 = <u16>concatenateBytes(
        Cpu.registerD,
        Cpu.registerE
      );
      checkAndSetSixteenBitFlagsAddOverflow(
    ...
    case 0x1a:
      // LD A,(DE)
      // 1 8
      let registerDEA: u16 = <u16>concatenateBytes(
        Cpu.registerD,
        Cpu.registerE
      );
    ...
    case 0x1b:
      // DEC DE
      // 1 8
      let registerDEB: u16 = <u16>concatenateBytes(
        Cpu.registerD,
        Cpu.registerE
      );
      registerDEB -= 1;
...
function handleOpcode2x(opcode: i32): i32 {
  switch (opcode) {
    ...
    case 0x22:
      // LD (HL+),A
      // 1 8
      let registerHL2: u16 = <u16>concatenateBytes(
        Cpu.registerH,
        Cpu.registerL
      );
    ...
    case 0x29:
      ...
      // 1  8
      // - 0 H C
      let registerHL9: u16 = <u16>concatenateBytes(
        Cpu.registerH,
        Cpu.registerL
      );
    ...
    case 0x2a:
      // LD A,(HL+)
      // 1  8
      let registerHLA: u16 = <u16>concatenateBytes(
        Cpu.registerH,
        Cpu.registerL
      );
...
function handleOpcode3x(opcode: i32): i32 {
  switch (opcode) {
    ...
    case 0x34:
      ...
      // 1  12
      // Z 0 H -
      let registerHL4: u16 = <u16>concatenateBytes(
        Cpu.registerH,
        Cpu.registerL
      );
    ...
    case 0x35:
      ...
      // 1  12
      // Z 1 H -
      let registerHL5: u16 = <u16>concatenateBytes(
        Cpu.registerH,
        Cpu.registerL
      );
    ...
    case 0x36:
      ...
      // 2  12
      eightBitStoreIntoGBMemoryWithTraps(
        <u16>concatenateBytes(Cpu.registerH, Cpu.registerL),
        getDataByteOne()
      );
      Cpu.programCounter += 1;
      return 12;
...
function handleOpcode4x(opcode: i32): i32 {
  switch (opcode) {
    ...
    case 0x46:
      // LD B,(HL)
      // 1 8
      Cpu.registerB = <u8>eightBitLoadFromGBMemoryWithTraps(
    ...
    case 0x4e:
      // LD C,(HL)
      // 1 8
      Cpu.registerC = <u8>eightBitLoadFromGBMemoryWithTraps(
        concatenateBytes(Cpu.registerH, Cpu.registerL)
      );
      return 8;
    case 0x4f:
...
function handleOpcode5x(opcode: i32): i32 {
  switch (opcode) {
    ...
    case 0x56:
      // LD D,(HL)
      // 1 8
      Cpu.registerD = <u8>eightBitLoadFromGBMemoryWithTraps(
        concatenateBytes(Cpu.registerH, Cpu.registerL)
      );
      return 8;
    case 0x57:
    ...
    case 0x5e:
      // LD E,(HL)
      // 1 4
      Cpu.registerE = <u8>eightBitLoadFromGBMemoryWithTraps(
        concatenateBytes(Cpu.registerH, Cpu.registerL)
      );
      return 4;
    case 0x5f:
...
function handleOpcode6x(opcode: i32): i32 {
  switch (opcode) {
    ...
    case 0x66:
      // LD H,(HL)
      // 1 8
      Cpu.registerH = <u8>eightBitLoadFromGBMemoryWithTraps(
        concatenateBytes(Cpu.registerH, Cpu.registerL)
      );
      return 8;
    case 0x67:
    ...
    case 0x6e:
      // LD L,(HL)
      // 1 8
      Cpu.registerL = <u8>eightBitLoadFromGBMemoryWithTraps(
        concatenateBytes(Cpu.registerH, Cpu.registerL)
      );
      return 8;
    case 0x6f:
...
function handleOpcode8x(opcode: i32): i32 {
  switch (opcode) {
    ...
    case 0x86:
      ...
      // 1 8
      // Z 0 H C
      let valueAtHL6: u8 = <u8>eightBitLoadFromGBMemoryWithTraps(
        concatenateBytes(Cpu.registerH, Cpu.registerL)
      );
    ...
    case 0x8e:
      ...
      // 1 8
      // Z 0 H C
      let valueAtHLE: u8 = <u8>eightBitLoadFromGBMemoryWithTraps(
        concatenateBytes(Cpu.registerH, Cpu.registerL)
      );
...
function handleOpcodeFx(opcode: i32): i32 {
  switch (opcode) {
    ...
    case 0xf5:
      ...
      sixteenBitStoreIntoGBMemoryWithTraps(
        Cpu.stackPointer,
        concatenateBytes(Cpu.registerA, Cpu.registerF)
      );
      return 16;
    case 0xf6:
      // OR d8
