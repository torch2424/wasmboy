...
function executeOpcode(opcode: u8, dataByteOne: u8, dataByteTwo: u8): i8 {
  ...
  if(opcodeHighNibble === 0x01) {
    if(isOpcode(opcode, 0x10)) {
  ...
  if(opcodeHighNibble === 0x02) {
    if(isOpcode(opcode, 0x20)) {
  ...
  if(opcodeHighNibble === 0x03) {
    if(isOpcode(opcode, 0x30)) {
  ...
  if(opcodeHighNibble === 0x04) {
    if(isOpcode(opcode, 0x40)) {
      // LD B,B
      // 1 4
  ...
  if(opcodeHighNibble === 0x05) {
    if(isOpcode(opcode, 0x50)) {
  ...
  if(opcodeHighNibble === 0x06) {
    if(isOpcode(opcode, 0x60)) {
  ...
  if(opcodeHighNibble === 0x07) {
    if(isOpcode(opcode, 0x70)) {
  ...
  if(opcodeHighNibble === 0x08) {
    if(isOpcode(opcode, 0x80)) {
      // ADD A,B
      // 1 4
      // Z 0 H C
  ...
  if(opcodeHighNibble === 0x09) {
    if(isOpcode(opcode, 0x90)) {
  ...
  if(opcodeHighNibble === 0x0A) {
    if(isOpcode(opcode, 0xA0)) {
  ...
  if(opcodeHighNibble === 0x0B) {
    if(isOpcode(opcode, 0xB0)) {
  ...
  if(opcodeHighNibble === 0x0C) {
    if(isOpcode(opcode, 0xC0)) {
  ...
  if(opcodeHighNibble === 0x0D) {
    if(isOpcode(opcode, 0xD0)) {
  ...
  if(opcodeHighNibble === 0x0E) {
    if(isOpcode(opcode, 0xE0)) {
  ...
  if(opcodeHighNibble === 0x0F) {
    if(isOpcode(opcode, 0xF0)) {
