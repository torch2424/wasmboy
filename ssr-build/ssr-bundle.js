...
var wasmboySystemControls_WasmBoySystemControls = function (_Component) {
  ...
  WasmBoySystemControls.prototype.render = function render(props) {
      ...
      this.state.saveStates.forEach(function (saveState) {
        ...
        saveStateElements.unshift(Object(preact_min["h"])(
          ...
          { 'class': 'saveState', onClick: function onClick() {
              props.wasmboy.loadState(saveState);_this3.closeSaveStates();
            } },
    ...
    return Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
        'div',
        { className: 'system-controls__file-input' },
        Object(preact_min["h"])('input', { type: 'file', onChange: function onChange(event) {
            _this3.loadGame(props.wasmboy, event);
          } })
      ),
      Object(preact_min["h"])(
        'button',
      ...
      this.state.showSaveStates ? Object(preact_min["h"])(
        ...
        Object(preact_min["h"])(
          'div',
          { 'class': 'popup-shadow-container', onClick: function onClick() {
...
// CONCATENATED MODULE: ./debugger/wasmboyOptions.js
...
var wasmboyOptions_WasmBoyOptions = function (_Component) {
  ...
  WasmBoyOptions.prototype.componentDidMount = function componentDidMount() {
    ...
    Object.keys(this.props.defaultOptions).forEach(function (optionKey) {
      newState[optionKey] = _this2.props.defaultOptions[optionKey];
    });
    this.setState(newState);
  };
  ...
  WasmBoyOptions.prototype.render = function render() {
      ...
      if (typeof _this3.state[stateOptionKey] === "number") {
        options.push(Object(preact_min["h"])(
          ...
          Object(preact_min["h"])(
            ...
            null,
            stateOptionKey,
            Object(preact_min["h"])("input", { type: "number", name: stateOptionKey, value: _this3.state[stateOptionKey], onChange: function onChange(event) {
    ...
    return Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
        "button",
        { "class": "wasmboy__options__apply", onClick: function onClick() {
            _this3.applyOptions();
          } },
        "Apply"
      )
...
var index__ref2 = Object(preact_min["h"])(
	'div',
	{ className: "wasmboy__options" },
	Object(preact_min["h"])(wasmboyOptions_WasmBoyOptions, { wasmBoy: WasmBoy, defaultOptions: wasmBoyDefaultOptions })
);
...
var index__ref8 = Object(preact_min["h"])(
	...
	Object(preact_min["h"])(wasmboySystemControls_WasmBoySystemControls, { wasmboy: WasmBoy, wasmboyMemory: WasmBoyMemory })
);
...
var index_App = function (_Component) {
	...
	App.prototype.render = function render() {
		...
		var optionsComponent = index__ref;
		if (this.state.showOptions) {
			optionsComponent = index__ref2;
		}

		// optionally render the debugger
		var debuggerComponent = index__ref3;
		if (this.state.showDebugger) {
			debuggerComponent = index__ref4;
		}
