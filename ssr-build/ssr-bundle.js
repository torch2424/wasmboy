...
var index_App = function (_Component) {
	...
	App.prototype.componentDidMount = function componentDidMount() {
		...
		WasmBoy.loadGame('./games/pokemoncrystal.gbc').then(function () {
			console.log('Wasmboy Ready!');
		}).catch(function (error) {
