    ...
    _renderFrameLoop = function renderFrameLoop(resolve) {
      requestAnimationFrame(function () {
        ...
        if (imageDataArray) {
          ...
          _this2.canvasContext.drawImage(_this2.canvasElement, 0, 0);
        }
        ...
        if (_this2.frameQueue.length > WASMBOY_MAX_FRAMES_IN_QUEUE) {
          // Push out extra frames
          var difference = _this2.frameQueue.length - WASMBOY_MAX_FRAMES_IN_QUEUE;
          _this2.frameQueue.splice(0, _this2.frameQueue.length - difference);
        }
...
var WASMBOY_MAX_AUDIO_DESYNC_IN_MILLI = 175;
...
var audio_WasmBoyAudioService = function () {
  ...
  WasmBoyAudioService.prototype.playAudio = function playAudio() {
    ...
    return new src(function (resolve) {
      ...
      var audioLatencyInSeconds = DEFAULT_AUDIO_LATENCY_IN_MILLI / 1000;
      var audioContextCurrentTimeWithLatency = audioContextCurrentTime + audioLatencyInSeconds;
      ...
      for (var i = WASMBOY_MEMORY_SOUND_INDEX; i - WASMBOY_MEMORY_SOUND_INDEX < wasmBoyNumberOfSamples * 2; i++) {
        ...
        var audioSample = _this.wasmByteMemory[i];
      ...
      var maxAudioDesyncInSeconds = WASMBOY_MAX_AUDIO_DESYNC_IN_MILLI / 1000;
      var desyncOverflowInMilli = (timeUntilNextSample - maxAudioDesyncInSeconds) * 1000;

      if (desyncOverflowInMilli > 0) {
        // Timeout before resolinvg a promise
        setTimeout(function () {
          resolve();
