...
class WasmBoyMemoryService {
  ...
  initialize(headless, saveStateCallback) {
    const initializeTask = async () => {
      if (headless) {
        ...
        await initializeAutoSave.bind(this)();
      }
    };
  ...
  clearMemory() {
    ...
    return this.worker
      ...
      .then(event => {
        this.wasmByteMemory = new Uint8Array(getEventData(event).message.wasmByteMemory);
  ...
  saveCartridgeRam(passedHeader, passedCartridgeRam) {
    const saveCartridgeRamTask = async () => {
      ...
      if (passedHeader && passedCartridgeRam) {
        ...
        header = getCartridgeHeader.bind(this)();
        cartridgeRam = getCartridgeRam.bind(this)();
      }
  ...
  saveState(passedHeader, passedSaveState) {
    const saveStateTask = async () => {
      ...
      if (passedHeader && passedSaveState) {
        ...
        saveState = getSaveState.bind(this)();
        header = getCartridgeHeader.bind(this)();
      }
  ...
  loadState(saveState) {
    const loadStateTask = async () => {
      ...
      if (saveState) {
        loadSaveState.bind(this)(saveState);
      ...
      loadSaveState.bind(this)(cartridgeObject.saveStates[0]);
  ...
  getCartridgeInfo() {
    ...
    let getCartridgeInfoTask = async () => {
      ...
      cartridgeInfo.header = getCartridgeHeader.bind(this)();
      cartridgeInfo.ROM = getCartridgeRom.bind(this)();
      cartridgeInfo.RAM = getCartridgeRam.bind(this)();
