...
class WasmBoyMemoryService {
  ...
  async loadBootRom(ROM) {
    const workerMemoryObject = {};
    workerMemoryObject[MEMORY_TYPE.BOOT_ROM] = ROM.buffer;
  ...
  async saveLoadedBootROM(additionalInfo) {
    // Create a SHA of our boot rom
    // const bootSha = await sha256(this.bootRom);
    // TODO: Rest
    /*
