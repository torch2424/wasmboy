...
export function getCartridgeRam() {
  ...
  let cartridgeType = this.wasmByteMemory[this.WASMBOY_GAME_BYTES_LOCATION + 0x0147];
  ...
  const cartridgeRam = this.wasmByteMemory.slice(this.WASMBOY_GAME_RAM_BANKS_LOCATION, this.WASMBOY_GAME_RAM_BANKS_LOCATION + ramSize);
  return cartridgeRam;
}
