...
class WasmBoyLib {
  ...
  _audio() {
    ...
    if(this.wasmInstance.exports.getAudioQueueIndex() < 4096) {
    ...
    for (let i = soundIndex; (i - soundIndex) < (wasmBoyNumberOfSamples * 2); i++) {
      ...
      if((i - soundIndex) % 2 == 0) {
        this.leftChannelBuffer[bufferIndex] = audioSample;
      } else {
        //this.rightChannelBuffer[bufferIndex] = audioSample;
        bufferIndex += 1;
      }
