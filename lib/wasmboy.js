...
import { WasmBoyMemory } from './wasmboyMemory';
        ...
        raf(() => {
          ...
          if(this.headless) {
            ...
            Promise.all([
              ...
              WasmBoyMemory.initialize(this.wasmByteMemory)
            ]).then(() => {
              ...
              // NOTE: This function is dependent one the cartridge ROM
              // This CANNOT run before loading that, or else you will be stuck foir 3 days :p
  ...
  loadState() {
    ...
    raf(() => {
      ...
      WasmBoyMemory.loadState().then(() => {
        // TODO: Something in wasm function below breaks save states
...
export { WasmBoyMemory } from './wasmboyMemory';
