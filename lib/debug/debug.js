// Extend the index.js
import { WasmBoy } from '../index';

import { WasmBoyLib } from '../wasmboy.js';
import { WasmBoyAudio } from '../audio/audio.js';

export const WasmBoyDebug = {
  WasmBoy: WasmBoy,
  getWasmInstance: () => {
  ...
  setWasmInstance: (wasmInstance) => {
    WasmBoyLib.wasmInstance = wasmInstance;
  },
  setWasmByteMemory: (wasmByteMemory) => {
