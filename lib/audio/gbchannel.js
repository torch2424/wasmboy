...
export default class GbChannelWebAudio {
  ...
  stopRecording(filename) {
    ...
    const recordingBuffer = this.audioContext.createBuffer(2, totalLeftBuffer.length, WASMBOY_SAMPLE_RATE);
    this._setSamplesToAudioBuffer(recordingBuffer, totalLeftBuffer, totalRightBuffer);
    ...
    const wav = toWav(recordingBuffer);
