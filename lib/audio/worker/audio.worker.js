  ...
  switch (eventData.message.type) {
    ...
    case WORKER_MESSAGE_TYPE.UPDATED: {
      ...
      audioDebuggingChannelBufferKeys.forEach(channelBufferKey => {
        ...
        if (channelBufferKey === 'channel2Buffer') {
          ...
          console.log('channel2 audio buffer', valueCount);
          ...
          console.log('channel2 left audio buffer', valueCountLeft);
          ...
          console.log('channel2 right audio buffer', valueCountRight);
        }
