...
const WASMBOY_MEMORY_SOUND_INDEX = 0x05B800;
    ...
    playAudio(currentFps) {
      return new Promise((resolve) => {
        ...
        if (this.audioPlaytime < audioContextCurrentTime) {
          ...
          console.log(`[Wasmboy] Reseting Audio Playback time: ${this.audioPlaytime.toFixed(2)} < ${audioContextCurrentTimeWithLatency.toFixed(2)}, Audio Queue IndexL ${this.wasmInstance.exports.getAudioQueueIndex()}`);
          this.cancelAllAudio();
