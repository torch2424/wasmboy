...
const WASMBOY_MAX_AUDIO_DESYNC_IN_MILLI = 250;
...
class WasmBoyAudioService {
    ...
    playAudio() {
      ...
      return new Promise((resolve) => {
        ...
        const audioLatencyInSeconds = DEFAULT_AUDIO_LATENCY_IN_MILLI / 1000
        let audioContextCurrentTimeWithLatency = audioContextCurrentTime + audioLatencyInSeconds;
        ...
        const maxAudioDesyncInSeconds = WASMBOY_MAX_AUDIO_DESYNC_IN_MILLI / 1000;
        const desyncOverflowInMilli = (timeUntilNextSample - maxAudioDesyncInSeconds) * 1000;
        console.log(desyncOverflowInMilli);
