...
class WasmBoyAudioService {
  ...
  playAudio(audioMessage) {
    ...
    if (this.gbChannels.master.muted && playingAllChannels) {
      console.log('playing master');
      this.gbChannels.master.unmute();

      this.gbChannels.channel1._muteSilently();
      this.gbChannels.channel2._muteSilently();
      this.gbChannels.channel3._muteSilently();
      this.gbChannels.channel4._muteSilently();
    } else if (!this.gbChannels.master.muted && !playingAllChannels) {
      console.log('muting master');
