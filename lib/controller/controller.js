...
class WasmBoyControllerService {
  ...
  enableDefaultJoypad() {
    ...
    // TODO: Enable some listeners for load / save state.
    // Load state button should open the last non auto save state.
    // and make an auto save state before hand.
    // Save state should not be considered auto.
    // Perhaps add a button to reset the gameboy as well :)
  }
