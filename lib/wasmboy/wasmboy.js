...
import { loadBootROMToWasmBoy, loadROMToWasmBoy } from './load';
...
class WasmBoyLibService {
  ...
  loadBootROM(file, fetchHeaders) {
    const boundLoadBootROM = loadBootROMToWasmBoy.bind(this);
    return boundLoadBootROM(file, fetchHeaders);
  }
  ...
  saveLoadedBootROM(additionalInfo) {
    return WasmBoyMemory.saveLoadedBootROM(additionalInfo);
  }
