...
import { instantiateWasmCore, instantiateTsCore } from './instantiate';
    ...
    switch (eventData.message.type) {
      ...
      case WORKER_MESSAGE_TYPE.INSTANTIATE_WASM: {
        ...
        const instantiateTask = async () => {
          let response;
          response = await instantiateWasmCore(eventData.message.wasmModuleUrl);
          response = await instantiateTsCore();
