  ...
  saveState() {
    ...
    return new Promise((resolve, reject) => {
      ...
      idbKeyval.get(header).then((cartridgeObject) => {
        ...
        idbKeyval.set(header, cartridgeObject).then(() => {
          console.log('Saved State!', cartridgeObject);
          resolve();
        }).catch((error) => {
          reject(error);
        });
  ...
  loadState() {
    return new Promise((resolve, reject) => {
      ...
      idbKeyval.get(header).then((cartridgeObject) => {
        ...
        // TODO: Pass in which save state to load
        loadSaveState(this.wasmByteMemory, cartridgeObject.saveStates[cartridgeObject.saveStates.length - 1]);
